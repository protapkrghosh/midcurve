        ...
        <div className="w-full top-0 left-0 z-10">
          <div className={`md:flex justify-between items-center ${color ? 'py-3' : 'py-7'}`}>
            ...
            <ul className={`text-[14px] 2xl:text-[16px] md:flex md:items-center md:py-3 pt-5 pb-7 space-y-4 md:space-y-0 absolute md:static md:z-auto z-[-1px] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-linear opacity-0 md:opacity-100 rounded-[5px] border ${color ? 'bg-[#e1f3e1] border-[#b2e1b2]' : 'bg-[#F7FFF7] border-[#b2e1b2]' } ${open ? 'top-[75px] opacity-100' : 'top-[-490px]'}`}>
              ...
              <li>
                <Link to="about" smooth={true} offset={-130} duration={700} className="text-[#36AE36] font-amulya font-normal md:ml-4 xl:ml-8 2xl:ml-10 my-4 md:my-0 cursor-pointer">About</Link>
              </li>

              <li>
                <Link to="fundamentals" smooth={true} offset={-130} duration={700} className="text-[#181818] hover:text-[#36AE36] font-amulya font-normal md:ml-4 xl:ml-8 2xl:ml-10 my-4 md:my-0 cursor-pointer duration-200">Fundamentals</Link>
              </li>

              <li>
                <Link to="tokenomics" smooth={true} offset={-130} duration={700} className="text-[#181818] hover:text-[#36AE36] font-amulya font-normal md:ml-4 xl:ml-8 2xl:ml-10 my-4 md:my-0 cursor-pointer duration-200">Tokenomics</Link>
              </li>

              <li>
                <Link to="buy" smooth={true} offset={-130} duration={700} className="text-[#181818] hover:text-[#36AE36] font-amulya font-normal md:ml-4 xl:ml-8 2xl:ml-10 my-4 md:my-0 cursor-pointer">How to Buy</Link>
              </li>
              
              <li>
                <Link to="connect" smooth={true} offset={-130} duration={700} className="text-[#181818] hover:text-[#36AE36] font-amulya font-normal md:mx-4 xl:mx-8 2xl:ml-10 my-4 md:my-0 cursor-pointer duration-200">Connect</Link>
              </li>
