...
const Fundamentals = () => {
  return (
    <div className='pb-40'>
      ...
      {/* Second section */}
      <div className='bg-[#E1E2F6] rounded-md flex mb-[213px]'>
        <div className='bg-no-repeat md:bg-right bg-contain md:mr-[90px] lg:mr-[100px] xl:mr-[120px]' style={{ backgroundImage: `url(${fundaIcon2})` }}>
